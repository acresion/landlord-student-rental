...
public class Tenant {
  ...
  public String toString() {
    return "Tenant [tenantId=" + tenantId + ", firstName=" + firstName + ", lastName=" + lastName
        ...
        + ", stateBeforeMovein=" + stateBeforeMovein + ", countryBeforeMovein=" + countryBeforeMovein + ", yearOfBirth="
        + yearOfBirth + ", monthOfBirth=" + monthOfBirth + ", dayOfBirth=" + dayOfBirth + ", room=" + room + ", floor="
        + floor + ", landlordId=" + landlordId + "]";
  }
  ...
  /**
   * We need to define our own hashCode method along with our own equals method
   * shown below
   */
  ...
  /**
   * Our own revised equals method, so we can check for similarity based on the
   * content
   */
