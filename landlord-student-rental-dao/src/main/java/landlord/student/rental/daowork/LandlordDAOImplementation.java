 ...
 * 
 * @author Alexandru
 * Here is our implementation of the LandlordDAO class
 */
public class LandlordDAOImplementation implements LandlordDAO {
	 ...
	 * I primarily coded this method, (similarly with getTenant in TenantDAOImplementation), where I just got the full list and told it to return the exact landlord on that list.
	 */
	@Override
	...
	/**
	 * The primary goal behind this method is to add a Landlord object to your database
	 */
	@Override
